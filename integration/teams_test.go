...
func TestTeams(t *testing.T) {
	...
	Convey("Test list teams (team members)", t, func() {
		...
		s := serializers.TeamCreateSerializer{Name: "new team"}
	...
	Convey("test create new team", t, func() {
		...
		Convey("test unauthorized", func() {
			...
			code := normal.Request("POST", settings.ROUTE_TEAMS_TEAM_LIST).
				JSONBody(serializers.TeamCreateSerializer{Name: "new team"}).Do().Response().Code
		...
		Convey("test sudo access", func() {
			...
			req := sudo.Request("POST", settings.ROUTE_TEAMS_TEAM_LIST).JSONBody(serializers.TeamCreateSerializer{Name: "new team"}).Do()
